...
<p>Don’t have an account? <a href="user_register.php">Sign Up</a> here</p>
<button class="submit-btn3" type="submit" name="submit" style="background-color: #FFC30B">Login</button>
 ...
 <?php
  if(isset($_POST['submit'])){
      ...
      $data = mysqli_query($sql_con,"SELECT *from clients where email='$email' AND password='$password'");
