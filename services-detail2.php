                ...
                <div id="site-content" class="site-content clearfix">
                    <div id="inner-content" class="inner-content-wrap">
                            ...
                            <div class="span_1_of_6 bg-f7f">
                                ...
                                <div class="themesflat-content-box clearfix" data-margin="0 10px 0 43px" data-mobilemargin="0 15px 0 15px">
                                    <div class="themesflat-headings style-2 clearfix">
                                        ...
                                        <h2 class="heading font-size-28 line-height-39">TRIMIX FLOORING</h2>
                        ...
                        <div class="flat-content-wrap style-2 clearfix">
                            ...
                            <p>Through our Trimix Flooring service, We are glad to introduce ourselves as the most Trusted & Leading Applicators for specialized Industrial Flooring's in Maharashtra like VDF Flooring, Epoxy Flooring, Laser Screeding, HTC Super floor, Polished Concrete or Ashford Formula. Due to our dedication to the quality, we are proud to have in-depth knowledge of this industry enabling us to earn the complete trust of our customers.</p>
                        </div>
                        ...
                        <div class="flat-content-wrap style-2 clearfix">
                            <div class="item">
                                <div class="inner">
                                    ...
                                    <p>We have successfully completed projects in numerous states across the continental United States. Shree Sai Construction Technology Services has a proven track record of:</p>
                                    ...
                                    <div class="themesflat-list has-icon style-1 icon-left size-16 clearfix">
                                        <div class="inner">
                                            <span class="item">
                                                ...
                                                <span class="text">PU Epoxy Flooring Service,</span>
                                            </span>
                                        </div>
                                    </div><!-- /.themeslat-list -->
                                    <div class="themesflat-list has-icon style-1 icon-left size-16 clearfix">
                                        <div class="inner">
                                            <span class="item">
                                                <span class="icon"><i class="fa fa-check-circle"></i></span>
                                                <span class="text">Self Leveling Epoxy Flooring Service</span>
                                            </span>
                                        </div>
                                    </div><!-- /.themeslat-list -->
                                    <div class="themesflat-list has-icon style-1 icon-left size-16 clearfix">
                                        <div class="inner">
                                            <span class="item">
                                                <span class="icon"><i class="fa fa-check-circle"></i></span>
                                                <span class="text">Anti Skid Epoxy Flooring Service</span>
                                            </span>
                                        </div>
                                    </div><!-- /.themeslat-list -->
                                    <div class="themesflat-list has-icon style-1 icon-left size-16 clearfix">
                                        <div class="inner" style="padding-bottom: 15px;">
                                            <span class="item">
                                                <span class="icon"><i class="fa fa-check-circle"></i></span>
                                                <span class="text">Waterproof Flooring Service and Resistant Epoxy Flooring Service</span>
                                            </span>
                                        </div>
                                    </div><!-- /.themeslat-list -->
                                </div>
