                                        ...
                                        <div class="col-md-6 bg-light-grey">
                                            ...
                                            <div class="themesflat-content-box clearfix" data-margin="0 25% 0 4.5%" data-mobilemargin="0 0 0 4.5%">
                                                <div class="themesflat-headings style-1 clearfix">
                                                    ...
                                                    <p class="sub-heading margin-top-30">We have successfully completed projects in numerous states across the Maharashtra,Mumbai. Shree Sai Construction Technology Services has a proven track record of:</p>
                                                </div>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-md-12">
                                                            ...
                                                            <div class="inner">
                                                                <div class="thumb data-effect-item has-effect-icon w40 offset-v-43 offset-h-46">
                                                                    ...
                                                                    <div class="text-wrap text-center">                                          
                                                                        <h5 class="heading"><a href="#">Bunglows</a></h5>
                                                                        <div class="elm-meta">
                                                        ...
                                                        <div class="project-item">
                                                            <div class="inner">
                                                                <div class="thumb data-effect-item has-effect-icon w40 offset-v-43 offset-h-46">
                                                                    ...
                                                                    <div class="text-wrap text-center">                             
                                                                        <h5 class="heading"><a href="#">Row House</a></h5>
                                                                        <div class="elm-meta">
                                                                            <span><a href="#">Architecture</a></span>
                                                                            <span><a href="#">Building</a></span>
                                                                        </div>
                                                        ...
                                                        <div class="project-item">
                                                            <div class="inner">
                                                                <div class="thumb data-effect-item has-effect-icon w40 offset-v-43 offset-h-46">
                                                                    ...
                                                                    <div class="text-wrap text-center">
                                                                        <h5 class="heading"><a href="#">Building</a></h5>
                                                                        <div class="elm-meta">
                                                                            <span><a href="#">Architecture</a></span>
                                                                            <span><a href="#">Building</a></span>
                                                                        </div>
                                            ...
                                            <div class="themesflat-spacer clearfix" data-desktop="41" data-mobile="35" data-smobile="35"></div>
                                            <div class="elm-button text-center">
                                                <a href="projects.php" class="themesflat-button bg-accent">Other PROJECTS </a>
                                            </div>
                                            <div class="themesflat-spacer clearfix" data-desktop="73" data-mobile="60" data-smobile="60"></div>
                                        </div><!-- /.col-md-12 -->
                                    </div><!-- /.row -->
                                        ...
                                        <div class="col span_1_of_4">
                                            ...
                                            <div class="themesflat-icon-box icon-left accent-color style-2 clearfix">
                                                ...
                                                <div class="text-wrap">
                                                    ...
                                                    <p class="sub-heading margin-top-18">Shree Sai Construction Technology Services provides the right resources and expertise to evaluate concepts through our industry leading Preconstruction Services team.</p>
                                                </div>
                                            </div><!-- /.themesflat-icon-box -->                                      
                                        </div><!-- /.col-md-4 -->
