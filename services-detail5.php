                ...
                <div id="site-content" class="site-content clearfix">
                    <div id="inner-content" class="inner-content-wrap">
                            ...
                            <div class="span_1_of_6 bg-f7f">
                                ...
                                <div class="themesflat-content-box clearfix" data-margin="0 10px 0 43px" data-mobilemargin="0 15px 0 15px">
                                    <div class="themesflat-headings style-2 clearfix">
                                        ...
                                        <h2 class="heading font-size-28 line-height-39">TILING FIXING</h2>
                        ...
                        <div class="flat-content-wrap style-2 clearfix">
                            ...
                            <p>Through our tiling fixing service, We are glad to introduce ourselves as the most Trusted & Leading Applicators for specialized tiling fixing projects's in Maharashtra.<br>
                            FixingUps provides complete flooring solutions for homeowners, businesses and property managers. Our skilled design team will assist you to plan the perfect aesthetic for your space, and our experienced flooring technicians will make it a reality. We emphasize the client in all that we do to provide an outstanding level of quality and customer service.  </p>
                        </div>
                        ...
                        <div class="flat-content-wrap style-2 clearfix">
                            <div class="item">
                                <div class="inner">
                                    ...
                                    <p>We have successfully completed projects in numerous states across the Maharashtra. Shree Sai Construction Technology Services has a proven track record of:</p>
                                    ...
                                    <div class="themesflat-list has-icon style-1 icon-left size-16 clearfix">
                                        <div class="inner">
                                            <span class="item">
                                                ...
                                                <span class="text">Window Cleaning</span>
                                            </span>
                                        </div>
                                    </div><!-- /.themeslat-list -->
                                    <div class="themesflat-list has-icon style-1 icon-left size-16 clearfix">
                                        <div class="inner">
                                            <span class="item">
                                                <span class="icon"><i class="fa fa-check-circle"></i></span>
                                                <span class="text">Floor Cleaning</span>
                                            </span>
                                        </div>
                                    </div><!-- /.themeslat-list -->
                                    <div class="themesflat-list has-icon style-1 icon-left size-16 clearfix">
                                        <div class="inner">
                                            <span class="item">
                                                <span class="icon"><i class="fa fa-check-circle"></i></span>
                                                <span class="text">Floor Fixing</span>
                                            </span>
                                        </div>
                                    </div><!-- /.themeslat-list -->
                                    <div class="themesflat-list has-icon style-1 icon-left size-16 clearfix">
                                        <div class="inner" style="padding-bottom: 15px;">
                                            <span class="item">
                                                <span class="icon"><i class="fa fa-check-circle"></i></span>
                                                <span class="text">Pressure Washing</span>
                                            </span>
                                        </div>
                                    </div><!-- /.themeslat-list -->
                                </div>
