                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="themesflat-headings style-1 text-center clearfix">
                                                ...
                                                <p class="sub-heading">More than 100+ projects completed in Shree Sai Construction Technology - With over 5 years of combined experience, we have the knowledge to serve you.</p>
                                            </div>
                                            ...
                                            <div class="themesflat-content-box clearfix" data-margin="0 5px 0 5px" data-mobilemargin="0 0 0 0">
                                                <div class="themesflat-icon-box icon-top align-center has-width w95 circle light-bg accent-color style-1 clearfix">
                                                    ...
                                                    <div class="text-wrap">
                                                        ...
                                                        <p class="sub-heading">Shree Sai Construction Technology Services are committed to meeting the highest quality standards without compromising our safety culture.</p>
                                                    </div>
                                        ...
                                        <div class="col-md-6 bg-light-grey">
                                            ...
                                            <div class="themesflat-content-box clearfix" data-margin="0 25% 0 4.5%" data-mobilemargin="0 0 0 4.5%">
                                                <div class="themesflat-headings style-1 clearfix">
                                                    <h2 class="heading">WELCOME TO BORN TO BUILD</h2>
                                                    <div class="sep has-width w80 accent-bg margin-top-11 clearfix"></div>                                               
                                                    <p class="sub-heading margin-top-30">We have successfully completed projects in numerous states across the continental United States. Shree Sai Construction Technology Services has a proven track record of:</p>
                                                </div>
                                                ...
                                                <div class="themesflat-counter style-1 align-center clearfix">
                                                    <div class="counter-item">
                                                        <div class="inner">
                                                            <div class="text-wrap">
                                                                <div class="number-wrap">
                                                                    <span class="number" data-speed="2000" data-to="98" data-inviewport="yes">98</span><span class="suffix">+</span>
                                                                </div>
                                                ...
                                                <div class="themesflat-counter style-1 align-center clearfix">
                                                    <div class="counter-item">
                                                        <div class="inner">
                                                            <div class="text-wrap">
                                                                <div class="number-wrap">
                                                                    <span class="number" data-speed="2000" data-to="65" data-inviewport="yes">65</span><span class="suffix">+</span>
                                                                </div>
                                                            ...
                                                            <div class="item-content">                                                            
                                                                ...
                                                                <div class="themesflat-list has-icon style-1 icon-left ofset-padding-32 clearfix">
                                                                    <div class="inner">
                                                                        <span class="item">
                                                                            <span class="icon"><i class="fa fa-check-square"></i></span>
                                                                            <span class="text">We have successfully completed projects in numerous parts of maharashtra.</span>
                                                                        </span>
                                                                    </div>
                                                                </div><!-- /.themeslat-list -->
                                                                <div class="themesflat-list has-icon style-1 icon-left ofset-padding-32 clearfix">
                                            ...
                                            <div class="themesflat-content-box" data-margin="0 0 0 18px" data-mobilemargin="0 0 0 0">
                                                ...
                                                <div class="themesflat-accordions style-1 has-icon icon-left iconstyle-1 clearfix">
                                                    <div class="accordion-item active">
                                                        <h3 class="accordion-heading"><span class="inner">Faqs goes there</span></h3>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="themesflat-carousel-box data-effect has-bullets bullet-circle bullet24 clearfix" data-gap="30" data-column="3" data-column2="2" data-column3="1" data-auto="true">
                                                <div class="owl-carousel owl-theme">
                                                    <?php
                                                        $data = mysqli_query($sql_con,"SELECT *from leaders where status ='1' ORDER BY id DESC LIMIT 10");
                                                        while ($row = mysqli_fetch_array($data)) {
                                                           ...
                                                           $data2 = mysqli_query($sql_con,"SELECT *from designations where id = '$leader_role'");
                                                           $row2 = mysqli_fetch_array($data2);
                                                           $des_name = $row2['des_name'];
                                                    ?>
                                                    <div class="themesflat-team style-1 align-center clearfix">
                                                        <div class="team-item">
                                                            <div class="inner">
                                                                <div class="thumb data-effect-item">
                                                                    <img src="sellers/<?php echo $img?>" alt="Image">
                                                                ...
                                                                <div class="text-wrap">
                                                                    ...
                                                                    <div class="position"><?php echo $email?></div>
                                                                    <div class="position"><?php echo $phone?></div>
                                                                    <div class="position"><?php echo $des_name?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div><!-- /.themesflat-team -->
