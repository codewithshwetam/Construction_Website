                ...
                <div id="site-content" class="site-content clearfix">
                    <div id="inner-content" class="inner-content-wrap">
                            ...
                            <div class="span_1_of_6 bg-f7f">
                                ...
                                <div class="themesflat-content-box clearfix" data-margin="0 10px 0 43px" data-mobilemargin="0 15px 0 15px">
                                    <div class="themesflat-headings style-2 clearfix">
                                        ...
                                        <h2 class="heading font-size-28 line-height-39">INDUSTRIAL PROJECTS</h2>
                        ...
                        <div class="flat-content-wrap style-2 clearfix">
                            ...
                            <p>Through our industrial project service, We are glad to introduce ourselves as the most Trusted & Leading Applicators for specialized Industrial Flooring's in Maharashtra.<br>
                            From greenfield construction to small cap and maintenance projects, Casey Industrial has the dexterity and specialized knowledge to provide everything you require for your project. We emphasize the client in all that we do to provide an outstanding level of quality and customer service.  </p>
                        </div>
                                    ...
                                    <div class="themesflat-list has-icon style-1 icon-left size-16 clearfix">
                                        <div class="inner">
                                            <span class="item">
                                                ...
                                                <span class="text">Project Development</span>
                                            </span>
                                        </div>
                                    </div><!-- /.themeslat-list -->
                                    <div class="themesflat-list has-icon style-1 icon-left size-16 clearfix">
                                        <div class="inner">
                                            <span class="item">
                                                <span class="icon"><i class="fa fa-check-circle"></i></span>
                                                <span class="text">Estimating</span>
                                            </span>
                                        </div>
                                    </div><!-- /.themeslat-list -->
                                    <div class="themesflat-list has-icon style-1 icon-left size-16 clearfix">
                                        <div class="inner">
                                            <span class="item">
                                                <span class="icon"><i class="fa fa-check-circle"></i></span>
                                                <span class="text">Pre-Construction Planning</span>
                                            </span>
                                        </div>
                                    </div><!-- /.themeslat-list -->
                                    <div class="themesflat-list has-icon style-1 icon-left size-16 clearfix">
